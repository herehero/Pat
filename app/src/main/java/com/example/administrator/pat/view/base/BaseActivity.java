package com.example.administrator.pat.view.base;
...
import com.example.administrator.pat.PatApplication;
import com.example.administrator.pat.R;
...
public abstract class BaseActivity extends Activity implements SurfaceStandard{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PatApplication.getInstance().addActivity(this);
